...
import contact from "../../assets/Tour3.jpeg"
          ...
          <div className="md:w-2/6">
            <div data-aos="fade-right"
              ...
              <div className="space-y-3">
                ...
                <h2 className="text-white font-semibold text-2xl cursor-pointer duration-300 pt-2">Akash Chowdhury</h2>
                <h4 className="text-gray-400 text-sm">Student And a Job Seeker</h4>
                <h4 className="text-gray-400 text-sm">I am available for a job. Connect with me via email and call in to my account.</h4>
                <h4 className="text-gray-400 text-sm">Phone: <a className="text-white" href="tel:+8801770717452">+880 17707-17452</a></h4>
                <h4 className="text-gray-400 text-sm">Email: <a className="text-white" href="mailto:akkuchowdhury49@gmail.com">akkuchowdhury49@gmail.com</a></h4>
                <div className="py-3">
