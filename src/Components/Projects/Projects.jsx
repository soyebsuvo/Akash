        ...
        <div id="projects" className="max-w-7xl mx-auto px-6 md:px-20 py-3 font-Montserrat">
            <div>
                <div className="mb-14 text-center">
                    <h3 className="text-[#FF014F] uppercase font-Montserrat mt-2 text-sm">VISIT MY TOURS AND KEEP YOUR FEEDBACK</h3>
                    <h2 className="text-5xl font-bold text-white mt-2">My Tours</h2>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    <div data-aos="fade-right"
                        ...
                        <img className="" src={tour1} alt="tour" />
                    </div>
                    <div data-aos="fade-up"
                        ...
                        <img className="" src={tour2} alt="tour" />
                    </div>
                    <div data-aos="fade-down"
                        ...
                        <img className="" src={tour3} alt="tour" />
                    </div>
                    <div data-aos="fade-right"
                        data-aos-offset="300"
                        ...
                        <img className="" src={tour4} alt="tour" />
                    </div>
                    <div data-aos="fade-up"
                        data-aos-offset="300"
                        ...
                        <img className="" src={tour5} alt="tour" />
                    </div>
                </div>
            </div>
