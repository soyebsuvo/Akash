          ...
          <div className="md:flex justify-between items-center text-gray-300">
            <div className="flex justify-between items-center w-full md:w-fit flex-row-reverse">
              ...
              <button className="btn btn-ghost text-3xl">
                ...
                {/* <span className="font-Montserrat font-bold relative">Akash<span className="font-Montserrat tracking-widest text-sm absolute -bottom-3 left-0">Chowdhury</span></span> */}
                <span className="font-Montserrat font-bold relative">Akash</span>
            ...
            <div className="hidden md:flex">
              <a href="#contact" className="text-[#FF014F] cursor-pointer font-Montserrat px-[30px] py-[10px] text-[14px] forShadow">Contact Me</a>
            </div>
          </div>
        </nav>
      </div>
