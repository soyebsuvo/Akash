...
export default function Footer() {
    return (
        <div className="max-w-7xl mx-auto px-2 md:px-20 py-3 font-Montserrat">
            <footer className="footer p-10 text-gray-300">
                <aside>
                    <button className="btn btn-ghost text-3xl">
                        ...
                        <span className="font-Montserrat font-bold">Akash</span>
                    </button>
            ...
            <p className="text-gray-400 text-center text-sm pt-4">&copy; 2025. All rights reserved by Akash Chowdhury</p>
        </div>
    )
}
